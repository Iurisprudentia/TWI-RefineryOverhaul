...
meta =
{
    ...
    name = "TWI-RefineryOverhaul",

    -- Title of your mod that will be displayed to players
    title = "TWI - Refinery Overhaul",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "An overhaul of resource depots and ship specialization regarding the refinement of raw ores.",

    -- Insert all authors into this list
    authors = {"Iurisprudentia"},{"TwerkBot"},
